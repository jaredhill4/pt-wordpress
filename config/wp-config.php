 ...
 */
$site_url = 'http' . (((!empty($_SERVER['HTTPS']) and 'off' !== $_SERVER['HTTPS']) or 443 == $_SERVER['SERVER_PORT']) ? 's' : '') . '://' . $_SERVER['SERVER_NAME'];

// Keep port in URL for local
if ('development' === WP_ENV || 'localhost' === $_SERVER['SERVER_NAME']) {
